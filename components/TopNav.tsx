...
export function TopNav({ onRun }: TopNavProps) {
  return (
    <nav className="mb-14 flex items-center justify-between">
      ...
      <button
        onClick={onRun}
        className="rounded-full border border-lime-300/30 bg-lime-300 px-5 py-2 text-sm font-bold text-black shadow-[0_0_40px_rgba(163,230,53,0.35)] transition hover:scale-105"
      >
        Run Demo
      </button>
    </nav>
